package io.github.closeddev.GUI.Layout;
...
public class VLayout implements LayoutManager{
...
//Constructors
     ...
     */
    public VLayout(int vgap,int alignment){
     ...
     */
    public VLayout(int vgap,int alignment,int anchor){
